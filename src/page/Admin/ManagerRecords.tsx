...
import { Typography, Table, Button, Space, Spin, Empty, Modal, Form, Input, message, Popconfirm, Row, Col, Statistic, Tabs } from 'antd';
...
import { getRecordings, getSentences, createSentence, updateSentence, deleteSentence, approveRecording, rejectRecording, Recording, Sentence } from '@/services/features/recordingSlice';
